...
function mainNav_controllScroll() { if ($_body.hasClass("openNav")) { if ($_body.removeClass("openNav"), $_body.hasClass("home") && eventMouseHome(!0), $("html,body").removeClass("change-page"), $_headNav.hasClass("hadColorId") && $_headNav.addClass("withColorId"), $_body.hasClass("ismobile")) return window.scroll(0, _yPositionMobileForNav), !1;
        $_mainNav.velocity({ translateY: ["-130%", 0] }, 0) } else { if ($_body.addClass("openNav"), $_body.hasClass("home") && eventMouseHome(!1), $("html,body").addClass("change-page"), $_headNav.hasClass("withColorId") && $_headNav.addClass("hadColorId").removeClass("withColorId"), $_body.hasClass("ismobile")) return _yPositionMobileForNav = _globalWindowScrollY, $_body.css("top", -_globalWindowScrollY), !1;
        $_mainNav.velocity({ translateY: [0, "-130%"] }, { duration: 700, easing: "easeOutExpo", mobileHA: !0 }) } return !1 }
...
function headerAnimExit(e) {
    function a() { return s = verge.scrollY(), $("html").hasClass("mobileBehavior") ? !1 : d && u > s ? !1 : t.hasClass("notrans") ? (t.removeClass("notrans"), !1) : c ? !1 : void(u >= s && r ? o(!1) : s > u && !r && o(!0)) }

    function o(e) { if (c = !0, e) stopPlayScroll(!0), t.addClass("go-push"), $.doTimeout(1200, function() { l.css({ top: 0 }).addClass("resetvalues"), l.parent().next().addClass("colorId"), stopPlayScroll(!1) }), n.hasClass("noColorId") || $.doTimeout(800, function() { i.addClass("withColorId") });
        else { return d = !0, void stopPlayScroll(!1);
            d = !0, stopPlayScroll(!1), t.removeClass("go-push"), n.hasClass("noColorId") || $.doTimeout(300, function() { i.removeClass("withColorId") }) } setTimeout(function() { r = !r, c = !1, e && (d = !1, stopPlayScroll(!1)) }, 1700) } var t = $(".mainPage.currentPage"),
        i = $("#headNav"),
        n = $("section"),
        l = $(".pageHeader"),
        s, r, d, c, u = l.height(); if (!e) return $_window.off("scroll", $.debounce(5, a)), !1; var v = verge.scrollY();
    d = !1, v > u && (r = !0, t.addClass("notrans"), t.addClass("go-push"), n.hasClass("noColorId") || i.addClass("withColorId")), $_window.on("scroll", $.debounce(5, a)) }
...
function navigationInPage(e) {
    function a() { var e = verge.viewportH();
        ...
        r = (verge.viewportH() / 3).toFixed(0); return t.click("clickTouchEvent", function() { var e = $(this),
            ...
            t = $("" + o); return goTo(t, 1700, null, a), !1 }), e ? void $_window.on("scroll", $.debounce(10, a)) : ($_window.off("scroll", $.debounce(10, a)), !1) }

function animGoDown(e) { var a = $(".animGodown"),
        o = $(".pageHeader"); return e ? a.addClass("animLoop") : a.animatePNG(50, 60, 40, 0), $("section").hasClass("home") ? !1 : void a.on("click", function(e) { if ($_body.hasClass("openNav")) return eventMouseBecauseFF(!1), stopPlayScroll(!1), !1; var a = $(this),
            t = $(this).attr("data-offset"),
            i = $(this).attr("data-speed");
        i || (i = 700); var n = $(this).attr("data-where"),
            l = $("." + n); if ($_body.hasClass("ismobile") || $_html.hasClass("mobileBehavior") || $_html.hasClass("ie")) return $_html.velocity("scroll", { duration: 700, offset: _globalWindowHeight, easing: [.7, 0, .3, 1], mobileHA: !1 }), !1; if ($("section").hasClass("market") || $(".mainPage").hasClass("go-push")) eventMouseBecauseFF(!1), goTo(l, 700, [.7, 0, .3, 1], t);
        else { stopPlayScroll(!1); var s = o.height();
            window.scroll(0, s + 1) } return !1 }) }
...
function initFiberAnimation(e) { return e ? void $_window.on("scroll", $.debounce(10, energyFiber_inViewport)) : ($_window.off("scroll", $.debounce(10, energyFiber_inViewport)), !1) }
...
function advantagesAnimation(e) { var a = $(".canScroll"); if (!e) return a.perfectScrollbar("destroy"), !1; var o = $(".list-features"),
        t = $(".list-features > li"),
...
function startAllNews() {
    function e(e) { var a = $(".mainNews.nextPageNews"),
            i = $(".mainNews.currentPageNews"),
            n = $(".mainNews.nextPageNews"),
            r = $(".newsContainer"),
            d = 3 * _globalWindowWidth,
            u = 0;
        $("html,body").addClass("change-page"), $_body.addClass("loading"), r.css("min-height", _globalWindowHeight), a.velocity({ scale: .9, translateX: d }), _globalWindowScrollY > 20 && (u = 400, $_html.velocity("scroll", { duration: 500, offset: 0, easing: [.7, 0, .3, 1], mobileHA: !1 })), $.doTimeout(u, function() { $_body.removeClass("noajax"), a.load(e + " .toloadNews", function() { var e = $(this);
                $(".mainNews.nextPageNews .gridToLoad").imagesLoaded(function(e, u, v) { var h = $(this).imagesLoaded();
                    h.always(function() {
                        function e() { $_body.removeClass("loading") }

                        function u() { i.remove() }

                        function v() { n.removeClass("nextPageNews"), n.addClass("currentPageNews"), n.after('<div class="mainNews nextPageNews"></div>'), a = $("mainNews.nextPageNews"), $(".mainNews.currentPageNews").attr("style", ""), r.attr("style", ""), $("html,body").removeClass("change-page"), a.velocity({ scale: .9, translateX: d }), c = !0, l = $(".currentPageNews .gridToLoad article").attr("data-nTpag"), s = 1, t(s, l), o() } i.velocity({ scale: [.9, 1] }, { duration: 400, easing: "ease-out" }).velocity({ translateZ: 0, translateX: [-d, 0] }, { duration: 300, easing: [.715, .02, 0, 1], delay: 10, complete: u }), n.velocity({ translateX: ["0", d] }, { duration: 300, easing: [.185, .33, .08, .93], delay: 400 }).velocity({ translateZ: 0, scale: [1, .9] }, { duration: 400, easing: "ease-out", delay: 10, begin: e, complete: v }) }) }) }) }) }

    function a(e) { var a = $(".mainRD.nextPageRD"),
            t = $(".mainRD.currentPageRD"),
            i = $(".mainRD.nextPageRD"),
            n = $(".RDContainer"),
            l = 3 * _globalWindowWidth,
            s = 0;
        $("html,body").addClass("change-page"), $_body.addClass("loading"), n.css("min-height", _globalWindowHeight), a.velocity({ scale: .9, translateX: l }), _globalWindowScrollY > 20 && (s = 400, $_html.velocity("scroll", { duration: 500, offset: 0, easing: [.7, 0, .3, 1], mobileHA: !1 })), $.doTimeout(s, function() { $_body.removeClass("noajax"), a.load(e + " .toloadRD", function() { var e = $(this);
                $(".mainRD.nextPageRD .toloadRD").imagesLoaded(function(e, s, r) { var d = $(this).imagesLoaded();
                    d.always(function() {
                        function e() { $_body.removeClass("loading") }

                        function s() { t.remove() }

                        function r() { i.removeClass("nextPageRD"), i.addClass("currentPageRD"), i.after('<div class="mainRD nextPageRD"></div>'), a = $("mainRD.nextPageRD"), $(".mainRD.currentPageRD").attr("style", ""), n.attr("style", ""), $("html,body").removeClass("change-page"), u = !0, a.velocity({ scale: .9, translateX: l }), o() } t.velocity({ scale: [.9, 1] }, { duration: 400, easing: "ease-out" }).velocity({ translateZ: 0, translateX: [-l, 0] }, { duration: 300, easing: [.715, .02, 0, 1], delay: 10, complete: s }), i.velocity({ translateX: ["0", l] }, { duration: 300, easing: [.185, .33, .08, .93], delay: 400 }).velocity({ translateZ: 0, scale: [1, .9] }, { duration: 400, easing: "ease-out", delay: 10, begin: e, complete: r }) }) }) }) }) }

    function o() { $("a#moreNews").click(function(e) { var a = $(this).attr("href");
            s += 1, $(this).addClass("loading"); var o = a + s,
                i = $.ajax(o); return i.done(function(e) { if (e.length > 0) { var a = $(e);
                    a.addClass("pointer"), a.css("opacity", 0), $(".currentPageNews .gridToLoad").append(a) } $.doTimeout(100, function() { $(".currentPageNews .gridToLoad .pointer").velocity("transition.slideUpIn", { stagger: 100, duration: 500, complete: function() { $(this).removeClass("pointer") } }) }), $("a#moreNews").removeClass("loading"), t(s, l) }), e.preventDefault(), !1 }) }

    function t(e, a) { var o = $("#nPagLoaded"); return o.text(e), 1 == a || e == a ? void $("a#moreNews, .forpages").hide() : void $("a#moreNews").show() } var i = $(".gridToLoad"),
        n = $("a#moreNews").attr("href"),
        l = $(".gridToLoad article").attr("data-nTpag"),
        s = 1,
        r = " | FiberSensing",
        d = $(".navPage-likeNews a"),
        c = !0,
        u = !0;
    o(), t(s, l), $(".navPage-likeNews a").click("clickTouchEvent", function(a) { var o = $(this); if (!$_body.hasClass("ismobile") && !$_html.hasClass("ie")) { if (!c) return !1;
            c = !1; var t = o.attr("href"),
                i = o.attr("data-title"),
                n = t,
                l = n,
                s = i + r; return d.parent().removeClass("on"), $(this).parent().addClass("on"), forPopstate && history.pushState({}, s, l), forPopstate = !0, $("head title").html(s), ga("send", "pageview", window.location.pathname), e(n), !1 } }), $(".navPage-likeRd a").click("clickTouchEvent", function(e) { var o = $(this); if (s = 1, !$_body.hasClass("ismobile") && !$_html.hasClass("ie")) { if (!u) return !1;
            u = !1; var t = o.attr("href"),
                i = o.attr("data-title"),
                n = t,
                l = n,
                d = i + r; return $(".navPage-likeRd li").removeClass("on"), $(this).parent().addClass("on"), $(this).parent().hasClass("publications") ? $(".navPage-likeNews").velocity({ opacity: 0 }, 500, function() { $(this).css("visibility", "hidden") }) : ($(".navPage-likeNews").css("visibility", "visible").velocity({ opacity: 1 }, 500), $(".navPage-likeNews li").removeClass("on"), $(".navPage-likeNews li:first-child").addClass("on")), forPopstate && history.pushState({}, d, l), forPopstate = !0, $("head title").html(d), ga("send", "pageview", window.location.pathname), a(n), !1 } }) }

function startPageProducts() {
    function e(e, o) { var i = $("." + o + " .mainProd.nextPageProd"),
            n = $("." + o + " .mainProd.currentPageProd"),
            l = $("." + o + " .mainProd.nextPageProd"),
            s = $("." + o + " .prodContainer"),
            r = 3 * _globalWindowWidth,
            d = 0;
        $("html,body").addClass("change-page"), $_body.addClass("loading"), i.velocity({ scale: .9, translateX: r }, 0), $_body.removeClass("noajax"), i.load(e + " .toloadProd", function() { var e = $(this),
                d = i.find(".toloadProd").height() + 20;
            s.velocity({ minHeight: d }, 100, "linear"), e.imagesLoaded(function(e, d, c) { var u = $(this).imagesLoaded();
                u.always(function() {
                    function e() { $_body.removeClass("loading") }

                    function d() { n.remove() }

                    function c() { l.removeClass("nextPageProd"), l.addClass("currentPageProd"), l.after('<div class="mainProd nextPageProd"></div>'), i = $("mainProd.nextPageProd"), $("." + o + " .mainProd.currentPageProd").attr("style", ""), s.attr("style", ""), $("html,body").removeClass("change-page"), i.velocity({ scale: .9, translateX: r }), t = !0, a() } n.velocity({ scale: [.9, 1] }, { duration: 400, easing: "ease-out" }).velocity({ translateZ: 0, translateX: [-r, 0] }, { duration: 300, easing: [.715, .02, 0, 1], delay: 10, complete: d }), l.velocity({ translateX: ["0", r] }, { duration: 300, easing: [.185, .33, .08, .93], delay: 400 }).velocity({ translateZ: 0, scale: [1, .9] }, { duration: 400, easing: "ease-out", delay: 10, begin: e, complete: c }) }) }) }) }

    function a() { $("a.moreProducts").click(function(e) { var a = $(this),
                o = a.parent().prev(".listprod-flex"),
                t = a.attr("href");
            a.addClass("loading"); var i = $.ajax(t); return i.done(function(e) { if (e.length > 0) { var t = $(e);
                    t.addClass("pointer"), t.css("opacity", 0), o.append(t) } $.doTimeout(100, function() { o.find(".pointer").velocity("transition.slideUpIn", { stagger: 100, duration: 500, complete: function() { $(this).removeClass("pointer") } }) }), a.removeClass("loading").fadeTo("slow", 0, function() { a.hide() }) }), e.preventDefault(), !1 }) } var o = $(".listprod-nav a"),
        t = !0;
    a(), startRoyalSliderProducts(), $(".listprod-nav a").click(function(a) { var o = $(this); if (!t) return !1;
        t = !1; var i = o.attr("href"),
            n = o.attr("data-section"),
            l = o.attr("data-url"),
            s = o.attr("data-all"),
            r = i; if ($(this).parent().siblings().removeClass("on"), $(this).parent().addClass("on"), s) { var d = $(".navPageProducts ul." + s);
            d.find("li").removeClass("on") } else { var c = $(".navPageProducts a[href='#" + l + "']");
            c.parent().parent().find("li").removeClass("on"), c.parent().addClass("on") } return window.location.hash = l, ga("send", "pageview", window.location.pathname), e(r, n), !1 }); var i = $(".navPageProducts");
    verge.viewportH() < i.height() && i.addClass("not-fixed"), $(".navPageProducts a").click(function(e) { var a = $(this),
            o = a.attr("href"),
            t = o.replace("#", "."),
            i = $("" + t); if (a.hasClass("has-toload")) { var n = -50;
            a.hasClass("no-slideshow") && (n = -165), goTo(i, 700, [.7, 0, .3, 1], n), $.doTimeout(710, function() { i.parent().hasClass("on") || i.click() }), a.parent().parent().find("li").removeClass("on"), a.parent().addClass("on") } else goTo(i, 700, [.7, 0, .3, 1]);
        e.preventDefault }), $(".slide-wrap .more a").click(function(e) { var a = $(this),
            o = a.parents("div").next("ul"); return goTo(o, 700, [.7, 0, .3, 1], -50), !1 }) }
...
function loadSection(e) {
    var a = $(".mainPage.currentPage"),
        o = $(".mainPage.nextPage"),
        t = _globalWindowWidth + 150;
    $("html,body").addClass("change-page"), $_body.addClass("loading"), $("#headNav").removeClass("hadColorId"), $_headNav.hasClass("withColorId") || $("#headNav").removeClass("withColorId"), animGoDown(!1), $_body.removeClass("noajax"), $_nextContentTemp.velocity({ scale: .9, translateX: t }), $(".mainPage.currentPage .toload").hasClass("home") && ($(".to-fixed").removeClass("fixed"), _global_webGL_teste = !1, homepage(!1)), $_nextContentTemp.load(e + " .toload", function() {
        var i = $(this);
        return i.find(".toload").removeClass("forRefresh"), i.html() ? (i.find(".toload").hasClass("home") || $("body").removeClass("home"), void $(".mainPage.nextPage #preload").imagesLoaded(function(e, n, l) {
            var s = $(this).imagesLoaded();
            s.always(function() {
                function e() { $_body.removeClass("loading"), $("#headNav").removeClass("withColorId") }

                function n() { a.remove() }

                function l() {
                    window.scroll(0, d), o.find(".bar-top").css({ height: "0" }), o.find(".bar-bottom").css({ height: "0" }), o.removeClass("nextPage"), o.addClass("currentPage"), o.after('<main class="mainPage nextPage" role="main"></main>'),
                        $_nextContentTemp = $(".mainPage.nextPage"), $(".mainPage.currentPage").attr("style", ""), $("html,body").removeClass("change-page"), $_nextContentTemp.velocity({ scale: .9, translateX: t }), headerAnimation(!1)
                }
                fullImageSize(), fullImageSize_min(), fullFixedBg();
                var s = _globalWindowScrollY + _globalWindowHeight / 2;
                a.css("transform-origin", "center " + s + "px 0");
                var r = _globalWindowScrollY + _globalWindowHeight;
                a.find(".bar-top").css({ height: "100%", top: r }), a.find(".bar-bottom").css({ height: _globalWindowScrollY });
                var d = 0,
                    c = 1,
                    u = $(".mainPage.nextPage .pageContent"),
                    v = $(".mainPage.nextPage .pageHeader");
                if ($_nextContentTemp.find("section").hasClass("header-push") && !$_html.hasClass("mobileBehavior")) { var d = $(".mainPage.nextPage .pageHeader").height(),
                        h = d / 2;
                    $_nextContentTemp.css("transform-origin", "center " + h + "px 0") }
                if (i.css({ top: -d }), v.css({ top: d }), $_nextContentTemp.find("section").hasClass("header-push") && !$_html.hasClass("mobileBehavior")) { var m = _globalWindowHeight + d;
                    o.find(".bar-bottom").css({ height: _globalWindowHeight }); var s = _globalWindowHeight + _globalWindowHeight / 2 } else var s = _globalWindowHeight / 2,
                    m = _globalWindowHeight;
                o.css("transform-origin", "center " + s + "px 0"), o.find(".bar-top").css({ height: "100%", top: m }), a.velocity({ scale: [.9, 1] }, { duration: 300, easing: "ease-out" }).velocity({ translateZ: 0, translateX: [-t, 0] }, { duration: 200, easing: [.715, .02, 0, 1], delay: 10, complete: n }), o.velocity({ translateX: ["0", t] }, { duration: 300, easing: [.185, .33, .08, .93], delay: 200 }).velocity({ translateZ: 0, scale: [1, .9] }, { duration: 400, easing: "ease-out", delay: 10, begin: e, complete: l })
            })
        })) : (window.location = e, !1)
    })
}

function openModal(e, a, o) { var t = $("#modalBg"),
        i = $("#modalWrapper"),
        n = $("#modalContent");
    $("html,body").addClass("modal-open"), $_body.addClass("loading"), fullImageSize_min(), n.velocity({ scale: .7, opacity: 0 }, 0), t.velocity({ opacity: 0 }, 0), $_body.hasClass("home") && eventMouseHome(!1), $_body.removeClass("noajax"), n.load(e + " .toload", function() {
        function i() { $_body.removeClass("loading"); var e = $("#modalWrapper .btnClose"),
                a = e.position();
            _globalYiniForBtnClose = a.top, $(".modal-open #modalWrapper").on("scroll", scroll_fixeBtnClose) } var l = $(this); if (closeModalReady(a, o), !l.html()) return window.location = e, !1; var s = $("#modalContent .toload img:eq(0)").imagesLoaded();
        s.always(function(e) { $("#modalContent .royalSlider").length ? do_royalslider = !0 : do_royalslider = !1, startRoyalSliderModal(do_royalslider), n.velocity({ scale: [1, .7] }, { duration: 700, easing: [.02, .78, 0, .95], queue: !1, delay: 50 }).velocity({ opacity: [1, 0] }, { duration: 200, easing: "ease" }), t.velocity({ opacity: [.8, 0] }, { duration: 1e3, easing: "ease", complete: i }) }) }) }

function closeModalReady(e, a) { $("#lightbox .btnClose").on("click", function(o) { return o.stopImmediatePropagation(), history.replaceState({}, a, e), $("head title").html(a), $("html,body").removeClass("modal-open"), $("#lightbox").remove(), $_body.hasClass("home") && eventMouseHome(!0), !1 }), $("#lightbox").on("clickoutside", function(e) { return e.stopImmediatePropagation(), $("#lightbox .btnClose").click(), !1 }) }

function scroll_fixeBtnClose() { var e = $(".modal-open #modalWrapper").scrollTop(); if (e >= _globalYiniForBtnClose) { var a = e - _globalYiniForBtnClose - 1;
        $(".btnClose").css({ transform: "translateY(" + a + "px)" }) } else $(".btnClose").css({ transform: "translateY(0)" }) }

function headerAnimation(e) { var a = $(".toload"),
        o = $(".pageHeader"); if (($_body.hasClass("ismobile") || $_html.hasClass("ie")) && a.removeClass("header-push"), a.hasClass("header-push") && !$("body").hasClass("ismobile")) { var t = o.height();
        o.css({ top: t }), window.scroll(0, t), $.doTimeout(50, function() { stopPlayScroll(!0), eventMouseBecauseFF(!0) }) } else { var t = 0;
        window.scroll(0, t) } $("body").removeClass("home"), a.hasClass("home") && ($("#mainNavList li, #mainNavList li a").removeClass("on"), $("#mainNavList li").removeClass("current-on"), $(".secNavList").attr("style", ""), $("body").addClass("home"), window.scroll(0, 0)), e ? (a.velocity({ opacity: 0 }, 0), $_body.addClass("loading"), ($_body.hasClass("ismobile") || $_html.hasClass("ie")) && "lightbox" == a.attr("id") && $_body.addClass("ismobile-lightbox"), $_toPreload.imagesLoaded(function(e, t, i) { var n = $(this).imagesLoaded();
        n.always(function() { $.doTimeout(1e3, function() { a.hasClass("header-push") && !$("body").hasClass("ismobile") && ($(".mainPage.currentPage").addClass("go-push"), a.removeClass("header-push"), o.css({ top: 0 }), $(".markerColor").addClass("colorId")), $_toPreload.remove(), $_body.removeClass("loading"), onStartPageForAjax(), window.scroll(0, 0), a.velocity({ opacity: 1 }, 400, function() { var e = $("footer");
                    e.hasClass("fixethis") || e.css("position", "fixed") }), $(".toload .royalSlider-modal").length ? do_royalslider = !0 : do_royalslider = !1, startRoyalSliderModal(do_royalslider), $("#lightbox .btnClose").click(function(e) { return window.location = $(this).attr("href"), !1 }); var e = window.location.hash;
                a.hasClass("products") && "" != e && $(".navPageProducts a[href=" + e + "]").click(), window.history.state }) }) })) : (stopPlayScroll(!0), eventMouseBecauseFF(!0), onStartPageForAjax()) }
...
var t = null,
i = $(".nav-home li");
if (!e) return $_window.off("scroll", home_onscrollControll),
$_window.off("keydown", home_keys),
webglWave("kill", "ourintro"),
_global_webGL_isAnimated = !1,
eventMouseHome(!1),
stopPlayScroll(!1),
$(".mainPage.currentPage .home .slide-wrapper").removeClass("fixed"),
$(".mainPage.currentPage .home .relative-wrapper").css("padding", "0"),
$.doTimeout("loop_homeVideo", !1),
!1;
if (window.scroll(0, 0), $(".mainPage.currentPage .home .slide-wrapper").addClass("fixed"), _global_home_timeAnim = 700, _global_home_lastAnimation = 0, _global_home_quietPeriod = 700, $_window.off("scroll", home_onscrollControll), $_window.on("keydown", home_keys), eventMouseHome(!0), stopPlayScroll(!1), _global_webGL_teste ? (webglWave("play", "ourintro"), _global_webGL_isAnimated = !0) : (webglWave("init", "ourintro"), _global_webGL_isAnimated = !0, _global_webGL_teste = !0), !$_body.hasClass("ismobile")) {
...
function eventMouseHome(e) { if (!$_body.hasClass("ismobile") && !$_html.hasClass("ie9")) { var a = /Firefox/i.test(navigator.userAgent) ? "DOMMouseScroll" : "mousewheel";
        e ? document.attachEvent ? document.attachEvent("on" + a, displaywheelHome) : document.addEventListener && document.addEventListener(a, displaywheelHome, !1) : document.removeEventListener(a, displaywheelHome, !1) } }

function displaywheel(e) { var a = window.event || e,
        o = a.detail ? -120 * a.detail : a.wheelDelta; if (0 >= o) { if (stopPlayScroll(!0), eventMouseBecauseFF(!1), $("section").hasClass("market")) return void stopPlayScroll(!1);
        $(".animGodown").click() } else stopPlayScroll(!0) }

function eventMouseBecauseFF(e) { var a = /Firefox/i.test(navigator.userAgent) ? "DOMMouseScroll" : "mousewheel";
    e ? document.attachEvent ? document.attachEvent("on" + a, displaywheel) : document.addEventListener && document.addEventListener(a, displaywheel, !1) : document.removeEventListener(a, displaywheel, !1) }
